      ...
      <main ref={containerRef}>
        <section className="feature-section h-[90dvh] p-16 flex items-center gap-8 justify-center">
          ...
          <div className="right flex items-center justify-center">
            <img src="/start/startUpUlu.jpg" alt="" className="w-[75%] rounded-[10%]" />
          </div>
        </section>
        <section className="feature-section h-[90dvh] p-16 flex items-center gap-8 justify-center bg-blue-50">
          <div className="left w-[45%] flex items-center justify-center">
            <img src="/start/equipe.jpg" alt="" className="w-[75%] object-contain rounded-[10%]" />
          </div>
        ...
        <section ref={sectionRef} className="feature-section bg-[#07081C] text-white p-16 flex flex-col gap-4 items-center" style={{ borderRadius: "2rem 2rem 0px 0px" }}>
        ...
        <section className="feature-section bg-[#07081C] text-white p-16 flex flex-col gap-8 items-center" style={{ borderRadius: "0rem 0rem 0rem 0rem" }}>
          ...
          <div className="carrocel reverse">
            <div className="group">
              <div className="card bg-[url('/start/cinza.jpg')]">
              </div>
              <div className="card bg-[url('/start/cinza.jpg')]">
              </div>
              <div className="card bg-[url('/start/cinza.jpg')]">
        ...
        <section className="feature-section h-[90dvh] p-16 flex items-center gap-8 justify-center bg-[#FDFDFD]">
          <div className="left w-[50%] flex flex-col gap-4">
            ...
            <button className="download shadow-lg shadow-blue-500/50 mt-4">Baixar&nbsp;&nbsp;<i className="fi fi-rr-download"></i></button>
          </div>
          <div className="cellphone right h-[100%]">
            <img src="/start/celular.jpeg" alt="" className="cellphone object-contain rounded-[10%]" style={{maxHeight: "100%"}} />
          </div>
        </section>
      </main>
      <Footer></Footer>
